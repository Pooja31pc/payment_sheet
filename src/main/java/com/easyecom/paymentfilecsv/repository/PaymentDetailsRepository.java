...
//   @Query("select new com.easyecom.paymentfilecsv.model.ResultSheet (p.orderNum , p.transferredAmount-p.costPrice, p.transferredAmount, p.transferredAmount, p.comission+p.paymentGateway+p.pickPackFee) from PaymentDetails p")
//
